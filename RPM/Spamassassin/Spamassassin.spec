...
BuildRequires: perl(DB_File) >= 1.835
...
BuildRequires: perl(Digest::MD5) >= 2.54
BuildRequires: perl(Digest::SHA) >= 5.95
BuildRequires: perl(ExtUtils::Constant) >= 0.23
BuildRequires: perl(ExtUtils::Install) >= 2.04
BuildRequires: perl(ExtUtils::MakeMaker) >= 7.10
BuildRequires: perl-libnet >= 1:3.08
BuildRequires: perl(Net::DNS::Resolver::Programmable)
BuildRequires: perl(Geo::IP) >= 1.45
