...
if ($_SESSION['user_type'] == 'A' || $_SESSION['user_type'] == 'D') {
         ...
         <OPTION VALUE=\"A\">Administrator</OPTION>
            ...
            case 'edit':
                if (!isset($_GET['submit'])) {
                    ...
                    {
                      echo "<INPUT TYPE=\"TEXT\" HIDDEN=\"true\" NAME=\"username\" VALUE=\"" . $row->username . "\">";
                    }
    ...
    <TD><SELECT NAME=\"type\">
         ...
         <OPTION " . $s["R"] . " VALUE=\"R\">User (Regexp)</OPTION>
                    ...
                    {
                     echo "<SELECT NAME=\"type\" HIDDEN=\"true\">
         <OPTION " . $s["A"] . " VALUE=\"A\">Administrator</OPTION>
         <OPTION " . $s["D"] . " VALUE=\"D\">Domain Administrator</OPTION>
         <OPTION " . $s["U"] . " VALUE=\"U\">User</OPTION>
         <OPTION " . $s["R"] . " VALUE=\"R\">User (Regexp)</OPTION>
...
";
    ...
    $arrusername = split('@',$_SESSION['myusername']);
    $regdomain = str_replace('.','\.',$arrusername[1]);
    $regdomain = '@'.$regdomain.'$';
...
";
    ...
    echo "<br>\n";
    if ($_SESSION['user_type'] == 'A') {echo "<a href=\"?action=new\">New User</a>\n";}
} else {
    if (!isset($_GET['submit'])) {
