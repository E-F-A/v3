#!/bin/bash
# +--------------------------------------------------------------------+
# EFA 3.0.1.6 build without ks version 20161225
#
# Purpose:
...
mkdir /var/log/EFA
mkdir /usr/src/EFA
/usr/bin/wget -q -O /usr/src/EFA/build.bash -o /var/log/EFA/wget.log https://raw.githubusercontent.com/E-F-A/v3/3.0.1.6/build/build.bash --no-check-certificate
