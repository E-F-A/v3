#!/bin/bash
# +--------------------------------------------------------------------+
# EFA 3.0.1.8 build without ks version 20170112
#
# Purpose:
...
mkdir /var/log/EFA
mkdir /usr/src/EFA
/usr/bin/wget -q -O /usr/src/EFA/build.bash -o /var/log/EFA/wget.log https://raw.githubusercontent.com/E-F-A/v3/3.0.2.1/build/build.bash --no-check-certificate
